...
public class Add extends Configured implements Tool {
    ...
    /* ... */
    public static class hprakashMapper1 extends Mapper<Object,Text,Pair,Triple>{
        @Override
    ...
    public static class hprakashReducer1 extends Reducer<Pair,Triple,Pair,Block> {
        @Override
        ...
        public static class hprakashMapper11 extends Mapper<Object,Text,Pair,Triple>{
        @Override
        public void map ( Object key, Text line, Context context )
                        throws IOException, InterruptedException {
    ...
    public static class hprakashReducer11 extends Reducer<Pair,Triple,Pair,Block> {
        @Override
        //static Vector<Triple> m_matrix_val = new Vector<Triple>();
        public void reduce ( Pair pair, Iterable<Triple> triples, Context context )
                           throws IOException, InterruptedException {
    ...
    public static class hprakashMapper2 extends Mapper<Pair,Block,Pair,Block>{
        @Override
    ...
    public static class hprakashMapper3 extends Mapper<Pair,Block,Pair,Block>{
        @Override
        public void map ( Pair pair, Block block, Context context )
                        throws IOException, InterruptedException {
                context.write(pair,block);
    ...
    public static class hprakashReducer2 extends Reducer<Pair,Block,Pair,Block> {
        @Override
    ...
    public static void main ( String[] args ) throws Exception {
		...
		MultipleInputs.addInputPath(job_1, new Path(args[0]), TextInputFormat.class, hprakashMapper1.class);
        //MultipleInputs.addInputPath(job_1, new Path(args[1]), TextInputFormat.class, hprakashMapper1.class);
        job_1.setMapperClass(hprakashMapper1.class);
		job_1.setReducerClass(hprakashReducer1.class);
		...
		MultipleInputs.addInputPath(job_11, new Path(args[1]), TextInputFormat.class, hprakashMapper11.class);
        //MultipleInputs.addInputPath(job_1, new Path(args[1]), TextInputFormat.class, hprakashMapper1.class);
        job_11.setMapperClass(hprakashMapper11.class);
		job_11.setReducerClass(hprakashReducer11.class);
        ...
        MultipleInputs.addInputPath(job_2, new Path(args[2]), TextInputFormat.class, hprakashMapper2.class);
        MultipleInputs.addInputPath(job_2, new Path(args[3]), TextInputFormat.class, hprakashMapper3.class);
        job_2.setMapperClass(hprakashMapper2.class);
        job_2.setMapperClass(hprakashMapper3.class);
		job_2.setReducerClass(hprakashReducer2.class);			
